...
fun FilledStarPreview() {
    ...
    FilledStar(starPath = starPath, starPathBounds = starPathBounds, scaleFactor = 1.1f)
}
...
fun HalfFilledStarPreview() {
    ...
    HalfFillStar(starPath = starPath, starPathBounds = starPathBounds, scaleFactor = 1.1f)
}
...
fun EmptyStarPreview() {
    ...
    EmptyStar(starPath = starPath, starPathBounds = starPathBounds, scaleFactor = 1.1f)
}